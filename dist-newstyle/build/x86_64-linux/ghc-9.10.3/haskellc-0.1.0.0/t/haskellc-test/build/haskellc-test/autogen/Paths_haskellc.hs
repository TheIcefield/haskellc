...
-- at runtime using the environment variable haskellc_bindir.
...
-- environment variable haskellc_libdir.
...
-- using the environment variable haskellc_dynlibdir.
...
-- runtime using the environment variable haskellc_datadir.
...
-- using the environment variable haskellc_sysconfdir.
...
libdir     = "/home/natalia/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3/haskellc-0.1.0.0-inplace-haskellc-test"
dynlibdir  = "/home/natalia/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3"
datadir    = "/home/natalia/.cabal/share/x86_64-linux-ghc-9.10.3-b4c3/haskellc-0.1.0.0"
libexecdir = "/home/natalia/.cabal/libexec/x86_64-linux-ghc-9.10.3-b4c3/haskellc-0.1.0.0"
sysconfdir = "/home/natalia/.cabal/etc"

getBinDir     = catchIO (getEnv "haskellc_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "haskellc_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "haskellc_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "haskellc_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "haskellc_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "haskellc_sysconfdir") (\_ -> return sysconfdir)
